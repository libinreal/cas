...
Vue.component('admin-user-index', {
    ...
    methods: {
        ...
        view_oauth: function view_oauth(item) {
        ...
        store: function store() {
            ...
            this.busy = true;
            this.$http.post(Laravel.router('user.store'), this.editUser).then(function (response) {
                _this.busy = false;
        ...
        update: function update() {
            ...
            this.busy = true;
            this.$http.put(Laravel.router('user.update', { user: this.editUser.id }), this.editUser).then(function (response) {
                _this2.busy = false;
                alert(response.data.msg);
                location.reload();
            });
